...
DATABASES = {
   'default': dj_database_url.parser{'postgresql://neondb_owner:npg_2Cmc5hTaIMeK@ep-small-cherry-acdbthui-pooler.sa-east-1.aws.neon.tech/neondb?sslmode=require
'}
}
